...
// GitHub update checker: gÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼nde 1 kez https://github.com/PlanC90/plugins kontrol
...
function wc_omnixep_remote_disable_notice()
{
    ...
    if (!$status['enabled']) {
        ...
        if (strpos($reason, 'ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Âikayet ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼zerine panelden kapatÃƒÆ’Ã¢â‚¬ÂÃƒâ€šÃ‚Â±ldÃƒÆ’Ã¢â‚¬ÂÃƒâ€šÃ‚Â±') !== false) {
